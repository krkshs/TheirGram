...
:: set App__DcOptions__0__IpAddress=192.168.0.200
...
:: set App__DcOptions__1__IpAddress=192.168.0.200
...
:: set App__DcOptions__2__IpAddress=192.168.0.200
...
:: set App__DcOptions__3__IpAddress=192.168.0.200
...
:: set App__WebRtcConnections__0__Ip=192.168.0.200
