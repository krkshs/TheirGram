...
# $env:App__DcOptions__0__IpAddress=192.168.0.200
...
# $env:App__DcOptions__1__IpAddress=192.168.0.200
...
# $env:App__DcOptions__2__IpAddress=192.168.0.200
...
# $env:App__DcOptions__3__IpAddress=192.168.0.200
...
# $env:App__WebRtcConnections__0__Ip=192.168.0.200
